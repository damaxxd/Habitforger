package com.group6.habitforger.core.presentation.widgets
...
import com.group6.habitforger.core.presentation.countBestStreak
import com.group6.habitforger.core.presentation.countCurrentStreak
import com.group6.habitforger.habits.data.database.HabitDbFactory
import kotlinx.coroutines.flow.first
import java.time.format.DateTimeFormatter

class HBWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = HBHabitWidget()
}

private val directionKey = ActionParameters.Key<String>("DirectionKey")

class HBHabitWidget : GlanceAppWidget() {
...
class UpdateIndexAction : ActionCallback {
    override suspend fun onAction(
        ...
        HBHabitWidget().update(context, glanceId)
    }
}
